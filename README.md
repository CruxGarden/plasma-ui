...
| `highlightSharpness` | `number` | `0` | How the pointer highlight reflects in the edge: `0` the broad, matte glow; `1` a compact reflection of a light held above the pointer, on the rim itself, in the band the iridescence lives in, like a lamp in the lip of a glass. Plasma material only |

...
| `highlightSharpness` | `number` | `0` | How the pointer highlight reflects in the edge: `0` the broad, matte glow; `1` a compact reflection of a light held above the pointer, sitting in the bevel like a lamp in the rim of a glass. Plasma material only |

...
- **No clipping in scroll containers.** Plasma inside a scrollable list draws past its edges. Scrolling *inside* one panel is fine.
...
- **Blobby surfaces / metaballs** - the fuse-on-contact behavior descends from Jim Blinn's [*A Generalization of Algebraic Surface Drawing*](https://dl.acm.org/doi/10.1145/357306.357310) (1982).
...
- **Spring integration** - panel motion uses semi-implicit Euler with fixed substeps, in the spirit of Glenn Fiedler's [*Integration Basics*](https://gafferongames.com/post/integration_basics/).
